...
public class CanvasPageDetailsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            case MainControllerServlet.ACTION_ADD_COMMENT_CANVAS -> addComment(request, response);
            case MainControllerServlet.ACTION_DELETE_COMMENT -> deleteComment(request, response);
            case MainControllerServlet.ACTION_EDIT_COMMENT -> editComment(request,response);
        }
    }
