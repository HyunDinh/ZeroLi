...
public class CanvasCommentServiceImpl implements CanvasCommnetService {
    private static final String COMMENT_FILE = "C:\\Users\\ADMIN\\Desktop\\ZeroLi\\ZeroLi\\src\\main\\java\\startup\\zeroli\\service\\canvas\\comment.csv";

    @Override
    public List<CanvasComment> listCommentsById(int id) {
        List<CanvasComment> comments = new ArrayList<>();
        try (BufferedReader br = new BufferedReader(new FileReader(COMMENT_FILE))) {
            String line;
    ...
    public void addComment(int canvasId, String username, String commentText) {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(COMMENT_FILE, true))) {
    ...
    public void deleteComment(int commentId) {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(COMMENT_FILE))) {
