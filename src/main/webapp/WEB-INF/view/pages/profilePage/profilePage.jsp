                        ...
                        <c:choose>
                            <c:when test="${hasAvatar}">
                                <img class="avatar-img" 
                                     src="${pageContext.request.contextPath}/resources/avatarUser/${user.email}.png"
                                     alt="User Avatar"
                                     onerror="this.src='${pageContext.request.contextPath}/resources/images/default-avatar.png'">
                            </c:when>
                            <c:otherwise>
                                <img class="avatar-img" 
                                     src="${pageContext.request.contextPath}/resources/avatarUser/default.jpg"
                                     alt="Default Avatar">
                            </c:otherwise>
                        </c:choose>
                    </div>

                    <form action="profilePage" method="post" enctype="multipart/form-data" class="avatar-upload">
